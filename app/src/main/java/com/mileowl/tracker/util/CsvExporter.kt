...
object CsvExporter {
    ...
    fun generateCsv(
        ...
        file.bufferedWriter().use { writer ->
            ...
            // Column headers
            writer.write("Date,Start Time,End Time,Start Address,End Address,Business Purpose,Client/Destination,Miles,Duration (min),Classification,IRS Rate,Deduction")
            writer.newLine()
            ...
            for (trip in trips) {
                ...
                val purpose = escapeCSV(trip.purpose ?: "")
                ...
                writer.write("$date,$startTime,$endTime,$startAddr,$endAddr,$purpose,$client,$miles,$duration,$classification,$rate,$deduction")
                writer.newLine()
            }
        }
